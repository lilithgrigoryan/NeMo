...
from nemo.collections.asr.parts.submodules.tdt_batched_beam_loop_labels_computer import BeamBatchedTDTLoopLabelsComputer
...
class BeamTDTInferBatched(_GreedyRNNTInfer):
    ...
    def __init__(
        ...
        if self.decoder.blank_as_pad:
            ...
            self._decoding_computer = BeamBatchedTDTLoopLabelsComputer(
